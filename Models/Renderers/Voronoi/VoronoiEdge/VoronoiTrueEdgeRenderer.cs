...
/// </summary>
public sealed class VoronoiTrueEdgeRenderer : IRenderer
{
    /// <inheritdoc/>
    public RendererDescriptor Descriptor => new("Voronoi True Edge", GetType(), typeof(VoronoiRendererSettings));
